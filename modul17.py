original_list = list(map(int, input("Введите любое целое положительное число через пробел:").split()))
element = int(input("Введите число для поиска в списке:"))

print(f'Вид изначального списка: {original_list}')
...
list_sorted = merge_sort(original_list)
